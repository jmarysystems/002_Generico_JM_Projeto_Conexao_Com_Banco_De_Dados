...
import Conexao_Com_Banco_De_Dados.Conexao_Com_Banco_De_Dados_Indice;
 ...
 * @author ana
 */
public class Conexao_Com_Banco_De_Dados_Submenu_01 extends javax.swing.JPanel {

    Home Home;
        
    public Conexao_Com_Banco_De_Dados_Submenu_01( Home Home2 ) {
        Home = Home2;
    ...
    private void initComponents() {
        ...
        btExercicios5.setText("Conexão com Banco de Dados");
    ...
    private void btExercicios5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Conexão Com Banco de Dados Índice", "livroTp.gif", new Conexao_Com_Banco_De_Dados_Indice(Home) ); 
