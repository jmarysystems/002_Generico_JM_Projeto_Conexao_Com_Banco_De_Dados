...
import conexao_com_banco_de_dados_menu_e_submenu.Conexao_Com_Banco_De_Dados_Menu_01;
 ...
 * @author NewUser
 */
public class Conexao_Com_Banco_De_Dados_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Conexao_Com_Banco_De_Dados_Menu_01( Home ).Barra_Menu );
        Home.adicionar_SubMenu( new Conexao_Com_Banco_De_Dados_Submenu_01( Home ) );
        Home.adicionar_Tela_De_Trabalho( "Conexão Com Banco de Dados Índice", new Conexao_Com_Banco_De_Dados_Indice(Home) );
    }
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new Conexao_Com_Banco_De_Dados_00_Main();
        applet.init();
